...
def upgrade() -> None:
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.Enum('engineer', 'stock_controller', name='rolesstatus'), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_index(op.f('ix_cost_evaluation_id'), 'cost_evaluation', ['id'], unique=True)
    ...
    op.create_index(op.f('ix_staff_staff_id_number'), 'staff', ['staff_id_number'], unique=True)
    op.create_table('stock_running',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.Column('status', sa.Enum('available', 're_order', name='runningstockstatus'), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    ...
    sa.Column('restrictions', sa.Enum('part_not_available', 'part_available', name='orderstatus'), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['barcode_id'], ['barcode.id'], ),
    ...
    op.create_index(op.f('ix_stock_adjustments_id'), 'stock_adjustments', ['id'], unique=True)
